...
function genesis_sample_customizer_register( $wp_customize ) {
	...
	$wp_customize->add_control(
		new WP_Customize_Color_Control(
			...
			'genesis_sample_link_color',
			array(
				'description' => __( 'Change the color of post info links, hover color of linked titles, hover color of menu items, and more.', 'know-more-marketing' ),
				'label'       => __( 'Link Color', 'know-more-marketing' ),
				'section'     => 'colors',
	...
	$wp_customize->add_control(
		new WP_Customize_Color_Control(
			...
			'genesis_sample_accent_color',
			array(
				'description' => __( 'Change the default hovers color for button.', 'know-more-marketing' ),
				'label'       => __( 'Accent Color', 'know-more-marketing' ),
				'section'     => 'colors',
	...
	$wp_customize->add_control(
		'genesis_sample_logo_width',
		array(
			'label'       => __( 'Logo Width', 'know-more-marketing' ),
			'description' => __( 'The maximum width of the logo in pixels.', 'know-more-marketing' ),
			'priority'    => 9,
