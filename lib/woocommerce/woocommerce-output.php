...
function genesis_sample_woocommerce_styles( $enqueue_styles ) {
	...
	$enqueue_styles['know-more-marketing-woocommerce-styles'] = array(
		'src'     => get_stylesheet_directory_uri() . '/lib/woocommerce/know-more-marketing-woocommerce.css',
		'deps'    => '',
...
function genesis_sample_woocommerce_css() {
	...
	if ( $woo_css ) {
		wp_add_inline_style( 'know-more-marketing-woocommerce-styles', $woo_css );
	}
