...
function genesis_sample_products_match_height() {
	...
	wp_enqueue_script(
		'know-more-marketing-match-height',
...
function genesis_sample_woocommerce_pagination( $args ) {
	...
	$args['prev_text'] = sprintf( '&laquo; %s', __( 'Previous Page', 'know-more-marketing' ) );
	$args['next_text'] = sprintf( '%s &raquo;', __( 'Next Page', 'know-more-marketing' ) );
